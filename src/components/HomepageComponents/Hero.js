  ...
  return (
    <Carousel controls={false} fade={true} pause={false}>
      <Carousel.Item interval={2000}>
        <img src={background} className={classes.HeroImages} alt="background"/>
        <Carousel.Caption>
          <h3 className={classes.Heroh1}>REDUCE</h3>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item interval={2000} pause={false}>
        <img src={background2} className={classes.HeroImages} alt="background1"/>
        <Carousel.Caption>
          <h3 className={classes.Heroh1}>REUSE</h3>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item interval={2000} pause={false}>
        <img src={mountain} className={classes.HeroImages} alt="background2"/>
        <Carousel.Caption>
